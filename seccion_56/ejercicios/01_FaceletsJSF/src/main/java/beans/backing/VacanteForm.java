...
public class VacanteForm {
    ...
    @Inject
    private ColoniaHelper coloniarHelper;
    ...
    public void codigoPostalListener(ValueChangeEvent valueChangeEvent){
        ...
        int coloniaId = this.coloniarHelper.getColoniaIdPorCP(nuevoCodigoPostal);
    ...
    public ColoniaHelper getColoniarHelper() {
        return coloniarHelper;
    }

    public void setColoniarHelper(ColoniaHelper coloniarHelper) {
        this.coloniarHelper = coloniarHelper;
    }
